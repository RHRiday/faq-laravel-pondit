<x-dashboard>
        ...
        <div class="col-md-11" style="margin-top: 30px;">
            <div class="panel panel-default">
                <div class="panel-body">
                    ...
                    @include('admin.partials.show_massage')
    ...
    {{-- Add Modal --}}
    <x-modal id="addModal" name="Add FAQ" action="/add_faq" />

    {{-- Update Model --}}
    <x-modal id="editModal" name="Update FAQ" action="/update_faq" status="hidden" cid1="question" cid2="answer"
